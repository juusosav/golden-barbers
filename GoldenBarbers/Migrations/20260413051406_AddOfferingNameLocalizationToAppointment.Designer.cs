...
namespace GoldenBarbers.Migrations
{
    ...
    [Migration("20260413051406_AddOfferingNameLocalizationToAppointment")]
    partial class AddOfferingNameLocalizationToAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoldenBarbers.Models.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("OfferingNameEn")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("OfferingNameFi")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GoldenBarbers.Models.Entities.Barber", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Rebecca has a natural talent for understanding what suits each client’s face shape and personality. She specializes in modern cuts, textured styles, and detailed finishing work. Her warm and welcoming approach ensures every visit feels comfortable and personalized.",
                            DescriptionFi = "Rebeccalla on luontainen kyky ymmärtää, mikä sopii kunkin asiakkaan kasvojen muotoon ja persoonallisuuteen. Hän on erikoistunut moderneihin leikkauksiin, teksturoituihin tyyleihin ja huolelliseen viimeistelyyn. Hänen lämmin ja vastaanottavainen otteensa tekee jokaisesta käynnistä mukavan ja yksilöllisen.",
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Charles is known for his sharp eye for style and perfectly sculpted beard work. With a passion for traditional barbering techniques and modern trends, he blends the best of both worlds. Clients appreciate his friendly personality and dedication to getting every detail right.",
                            DescriptionFi = "Charles tunnetaan tarkasta tyylisilmästään ja huolellisesti muotoilemistaan parroista. Intohimollaan perinteisiä parturitekniikoita ja moderneja trendejä kohtaan hän yhdistää näiden parhaat puolet. Asiakkaat arvostavat hänen ystävällistä luonnettaan ja omistautumistaan jokaisen yksityiskohdan viimeistelyyn.",
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Hannah combines creativity with technical skill to deliver standout results. She enjoys working with both classic styles and bold, modern looks, always tailoring each cut to the individual. Her friendly attitude and attention to detail make her a favorite among clients.",
                            DescriptionFi = "Hannah yhdistää luovuuden ja teknisen taidon tuottaakseen erinomaisia tuloksia. Hän nauttii työskentelystä sekä klassisten tyylien että rohkeiden modernien ilmeiden parissa, räätälöiden jokaisen leikkauksen yksilöllisesti. Hänen ystävällinen asenteensa ja tarkkuutensa tekevät hänestä asiakkaiden suosikin.",
                            Name = "Hannah Lawson",
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Steve is our talented trainee, bringing fresh energy and a strong desire to master the craft. He is currently refining his skills under the guidance of our senior team, focusing on clean cuts and precise styling. Steve is detail-oriented, patient, and committed to continuous improvement.",
                            DescriptionFi = "Steve on lahjakas harjoittelijamme, joka tuo mukanaan tuoretta energiaa ja vahvan halun kehittyä alan ammattilaiseksi. Hän hioo taitojaan parhaillaan senioritiimimme ohjauksessa keskittyen siisteihin leikkauksiin ja tarkkoihin tyyleihin. Steve on yksityiskohtiin paneutuva, kärsivällinen ja sitoutunut jatkuvaan kehittymiseen.",
            ...
            modelBuilder.Entity("GoldenBarbers.Models.Entities.Offering", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Haircut with a complete beard treatment package including steaming and grooming",
                            DescriptionFi = "Hiustenleikkaus täydellisellä parran hoitopaketilla, sisältää höyrytyksen ja siistimisen",
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Old-school treatment package for a dutch beard style includingfinishing with oils",
                            DescriptionFi = "Vanhan koulukunnan hoitopaketti hollantilaisen partatyylin mukaan sisältäen hoitoviimeistelyn öljyillä",
                        ...
                        new
                        {
                            ...
                            DescriptionEn = "Classic american beard trimming with a razorblade and foaming",
                            DescriptionFi = "Klassinen amerikkalainen parran trimmaus partaterällä ja vaahdotuksella",
